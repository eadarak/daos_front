...
const headCells = [
  ...
  { id: 'dureeSeance', numeric: false, disablePadding: false, label: 'Duree Seance'},
  { id: 'debutSeance', numeric: false, disablePadding: false, label: 'Debut Seance' },
  { id: 'finSeance', numeric: false, disablePadding: false, label: 'Fin Seance' },
  { id: 'numeroSeance', numeric: false, disablePadding: false, label: 'Numero Seance' },
  { id: 'dateCreationSeance', numeric: false, disablePadding: false, label: 'Date Creation' },
...
export default function ListeSeance() {
  ...
  React.useEffect(() => {
    axios.get('http://localhost:8084/emploi/seance')
                  ...
                  .map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">{row.dateCreationSeance}</TableCell>
                        <TableCell > 
