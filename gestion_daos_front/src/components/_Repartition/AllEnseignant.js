...
function AllEnseignant() {
    ...
    const [newAllEnseignant, setNewAllEnseignant] = useState('');
        ...
        <div>
           <Card id="card" style={{ display: 'flex', flexDirection: 'column', height: '12rem' }}>
                <CardContent style={{ flex: '1 0 auto', position: 'relative' }} id="content-card">
                    ...
                    <Typography variant="h5">→<b> &nbsp;Nos Enseignants</b></Typography>
                    <Typography variant="body1" sx={{fontSize: "1.4rem !important", fontFamily:"Poppins"}}>
                        Cette page vous redirige vers la liste de
                        de tous les Enseignants .
                    </Typography>
                </CardContent>
                <CardActions>
                    <Button href="/listeAllEnseignant" id='mybtnStyle'>Voir tous les Enseignants</Button>
                </CardActions>
            </Card>
            <Menu
                id="simple-menu"
