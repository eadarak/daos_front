...
function Modifier_Maquette ({ maquette, open, onClose }) {
    ...
    const [data, setData] = React.useState(maquette);
    ...
    const handleSubmit = (e) => {
        ...
        fetch(`${MAQUETTE_URL}maquette/${maquette.idMaquette}`, {
            method : 'PUT',
        ...
        .then(data => {
            ...
            setData(modelMaquette);
            onClose();
            navigate('/listeMaquette', { replace: true });
                ...
                <Box sx={{ backgroundColor: 'white', p: 2, width: 800 , borderRadius:"10px"}}>
                    ...
                    <Grid container spacing={2}>
                            <Grid item xs={6}>
                                <TextField
                                    id="libelleMaquette"
                                    label="Libellé Maquette"
                                    required
                                    fullWidth
                                    value={data.libelleMaquette}
...
export default Modifier_Maquette;
