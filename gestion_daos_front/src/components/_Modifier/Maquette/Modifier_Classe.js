...
function Modifier_Classe ({ classe, open, onClose }) {
    ...
    const [data, setData] = React.useState(classe);
    ...
    const handleSubmit = (e) => {
        ...
        fetch(`${MAQUETTE_URL}classe/${classe.idClasse}`, {
            method : 'PUT',
        ...
        .then(data => {
            ...
            setData(initialClasse);
            onClose();
            navigate('/listes-classe', { replace: true });
...
export default Modifier_Classe;
