...
function Modifier_VAC ({ vac, open, onClose }) {
    ...
    const [data, setData] = React.useState(vac);

    const handleChangeVAC = (e) => {
        e.preventDefault();
        e.stopPropagation();
    ...
    const handleSubmit = (e) => {
        ...
        fetch(`${REPARTITION_URL}/vacataire/${vac.idEns}`, {
            method : 'PUT',
        ...
        .then(data => {
            console.log('VAC modifiée avec succès', data);
            setData(modelVAC);
            onClose();
            navigate('/listeVAC', { replace: true });
