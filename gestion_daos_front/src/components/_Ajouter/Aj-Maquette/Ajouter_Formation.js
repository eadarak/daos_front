...
function Ajouter_Formation () {
    ...
    const [data, setFormData] = React.useState(initialFormation);
    ...
    const handleSubmit = (e) =>{
        ...
        .then(
            data => {
                console.log('Une nouvelle formation a été ajoutée avec succès' ,data);
                setFormData(initialFormation);
                setOpen(false);
                navigate('/listes-formation');
...
export default Ajouter_Formation;
