...
function Ajouter_Maquette() {
    ...
    const [data, setFormData] = React.useState(modelMaquette);
    ...
    const handleSubmit = (e) => {
        ...
        .then(data => {
            console.log('Une nouvelle maquette a été ajoutée avec succès', data);
            setFormData(modelMaquette);
            setOpen(false);
            navigate('/listeMaquette');
        })
        .catch(err => {
...
export default Ajouter_Maquette;
