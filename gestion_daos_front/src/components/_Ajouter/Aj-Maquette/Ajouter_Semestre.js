...
function Ajouter_Semestre () {
    ...
    const [data, setFormData] = React.useState(modelSemestre);
    ...
    const handleSubmit = (e) =>{
        ...
        .then(
            data => {
                console.log('Une nouvelle Semestre a ete ajoute avec succes' ,data);
                setFormData(modelSemestre);
                setOpen(false);
                navigate('/listeSemestre');
...
export default Ajouter_Semestre;
