...
function Ajouter_Filiere () {
    ...
    const [data, setFormData] = React.useState(initialFiliere);
    ...
    const handleSubmit = (e) =>{
        ...
        .then(
            data => {
                console.log('Une nouvelle filiere a été ajoutée avec succès' ,data);
                setFormData(initialFiliere);
                setOpen(false);
                navigate('/listes-filiere');
...
export default Ajouter_Filiere;
