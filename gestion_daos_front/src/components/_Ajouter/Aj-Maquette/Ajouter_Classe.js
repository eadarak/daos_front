...
function Ajouter_Classe () {
    ...
    const [data, setFormData] = React.useState(initialClasse);
    ...
    const handleSubmit = (e) =>{
        ...
        .then(
            data => {
                console.log('Une nouvelle classe a été ajoutée avec succès' ,data);
                setFormData(initialClasse);
                setOpen(false);
                navigate('/listes-classe');
                    ...
                    <Stack spacing={2} direction="column" sx={{ width: '95%' }}>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={6}>
                                <TextField
                                    id="effectifClasse"
                                    label="Effectifs de la Classe"
                                    fullWidth
                                    required
                                    value={data.effectifClasse}
                                    onChange={handleChange}
                                />
                            </Grid>
                            <Grid item xs={12}>
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    id="descriptionClasse"
                                    label="description de la Classe"
                                    variant="filled"
                                    fullWidth
                                    multiline
                                    rows={3}
                                    value={data.descriptionClasse}
                                    onChange={handleChange}
                                />
                            </Grid>
                        </Grid>
