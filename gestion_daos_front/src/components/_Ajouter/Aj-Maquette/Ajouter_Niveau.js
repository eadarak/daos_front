...
function Ajouter_Niveau () {
    ...
    const [data, setFormData] = React.useState(initialNiveau);
    ...
    const handleSubmit = (e) =>{
        ...
        .then(
            data => {
                console.log('Une nouvelle niveau a été ajoutée avec succès' ,data);
                setFormData(initialNiveau);
                setOpen(false);
                navigate('/listes-niveau');
