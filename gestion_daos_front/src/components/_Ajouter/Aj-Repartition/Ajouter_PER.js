...
function Ajouter_PER () {
    ...
    const [data, setFormData] = React.useState(modelPER);
    ...
    const handleSubmit = (e) =>{
        ...
        .then(
            data => {
                console.log('Un nouveau PER a ete ajoute avec succes' ,data);
                setFormData(modelPER);
                setOpen(false);
                navigate('/listePER');
