...
const HeadersNiveau = ['Identifiant', 'Description'];
...
function DetailsCycle ({ cycle }) {
    ...
    // useEffect(() => {
    //     axios.get(`${MAQUETTE_URL}cycle/${cycle.idCycle}/repartitions`)
    //       .then(res => {
    ...
    return (
        <div>
            ...
            <div id='BlockBtn'>
                {/* <Ajouter_EC_UE cycle={cycle}/>
                <Ajouter_Module_UE cycle={cycle}/> */}
                {/* <Ajouter_Cycle_Classe cycle={cycle}/> */}
            </div>
