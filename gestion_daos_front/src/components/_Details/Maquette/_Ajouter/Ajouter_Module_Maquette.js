...
function Ajouter_Module_Maquette({ maquette }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (selectedModule !== null) {
            fetch(`${MAQUETTE_URL}maquette/${maquette.idMaquette}/modules/${selectedModule.idModule}`, {
                method: 'PUT',
                headers: {
...
export default Ajouter_Module_Maquette;
