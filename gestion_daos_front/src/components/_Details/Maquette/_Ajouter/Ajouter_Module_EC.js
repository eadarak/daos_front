...
function Ajouter_Module_EC({ ec }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (selectedModule !== null) {
            ...
            .then(response => {
                if (!response.ok) {
                    throw new Error("Erreur lors de l'ajout du module à l'EC");
                }
                                    ...
                                    <Grid item xs={12} key={module.idModule}>
                                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                            ...
                                            <Typography variant="body1">
                                                {`${module.idModule} - ${module.libelleModule} - ${module.coursModule}`} {/* Display all information */}
                                            </Typography>
                                        </Box>
                                    </Grid>
                                ))}
...
export default Ajouter_Module_EC;
