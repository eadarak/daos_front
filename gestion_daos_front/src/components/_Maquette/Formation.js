        ...
        <div>
           <Card id="card" style={{ display: 'flex', flexDirection: 'column', height: '12rem' }}>
                <CardContent style={{ flex: '1 0 auto', position: 'relative' }} id="content-card">                    <IconButton
                    ...
                    <Typography variant="h5">→<b> &nbsp;Formation</b></Typography>
                    <Typography variant="body1" sx={{fontSize: "1.4rem !important", fontFamily:"Poppins"}}>
                        Cette page vous redirige vers la liste des Formations.
                    </Typography>
                </CardContent>
                <CardActions>
                    <Button href="/listes-formation" id='mybtnStyle'>Voir liste Formation</Button>
                </CardActions>
            </Card>
            <Menu
                id="simple-menu"
            ...
            >
                <MenuItem>
                    <Ajouter_Formation open={Boolean(anchorEl)} onClose={handleClose} />
                </MenuItem>
            </Menu>
        </div>
    );
