        ...
        <div>
            <Card id="card" style={{ display: 'flex', flexDirection: 'column', height: '12rem' }}>
                <CardContent style={{ flex: '1 0 auto', position: 'relative' }} id="content-card">
                    ...
                    <Typography variant="h5">→<b> &nbsp;Niveau</b></Typography>
                    <Typography variant="body1" sx={{fontSize: "1.4rem !important", fontFamily:"Poppins"}}>
                        Cette page vous redirige vers la liste des Niveau.
                    </Typography>
                </CardContent>
                <CardActions>
                    <Button href="/listes-niveau" id='mybtnStyle'>Voir liste Niveau</Button>
                </CardActions>
            </Card>
            <Menu
                id="simple-menu"
            ...
            >
                <MenuItem>
                    <Ajouter_Niveau open={Boolean(anchorEl)} onClose={handleClose} />
                </MenuItem>
            </Menu>
        </div>
    );
