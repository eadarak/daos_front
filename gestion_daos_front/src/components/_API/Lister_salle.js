...
const headCells = [
  ...
  { id: 'salle', numeric: false, disablePadding: false, label: 'Libellé' },
  { id: 'codeSalle', numeric: false, disablePadding: false, label: 'Code'},
  { id: 'capacite', numeric: false, disablePadding: false, label: 'Capacité' },
  { id: 'batiment', numeric: false, disablePadding: false, label: 'Batiment' },
  { id: 'position', numeric: false, disablePadding: false, label: 'Position du Batiment' },
